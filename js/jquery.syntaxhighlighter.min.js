...
this.fn;e.load&&this.load();e.highlight&&this.highlight();return this},load:function(){var b=this.config,e=b.prettifyBaseUrl,c=b.baseUrl;b=b.themes;if(!this.loaded()){a.appendScript(e+"/js/prettify.min.js");a.appendStylesheet(e+"/css/prettify.min.css");a.appendStylesheet(c+"/styles/style.min.css");a.each(b,function(d,f){a.appendStylesheet(c+"/styles/theme-"+f+".min.css")});a.browser.msie&&a.appendStylesheet(c+"/styles/ie.min.css");this.loadedExtras=true}return this},loadedExtras:false,loaded:function(){return typeof prettyPrint!==
